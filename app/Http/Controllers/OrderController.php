...
class OrderController extends Controller
{
	...
	public function print_order_convert($checkout_code){
		...
		<h1><center>ĐẠI LÝ LỌC NƯỚC NÚI THÀNH</center></h1>
		...
		<p style="margin-left:50px;">Ký tên</p>
		<table>
		<thead>
		<tr>
	...
	public function history(Request $request){
		if(!Session::get('customer_id')){
	    	...
	    	return view('pages.history.history')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('category_post',$category_post)->with('getorder',$getorder); //1
		}
	}
