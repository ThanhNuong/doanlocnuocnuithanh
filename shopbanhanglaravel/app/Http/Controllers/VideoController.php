...
class VideoController extends Controller
{
    ...
    public function video_shop(Request $request){
        ...
        //seo 
        $meta_desc = "Video lọc nước Núi Thành"; 
        $meta_keywords = "karofi";
        $meta_title = "Videos";
    	...
    	return view('pages.video.video')->with('category',$cate_product)->with('brand',$brand_product)->with('all_video',$all_video)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('category_post',$category_post); //1
    ...
    // 	$all_post = Video::with('cate_post')->orderBy('cate_post_id')->get();
       
    // 	return view('admin.video.list_video')->with(compact('all_post',$all_post));
