...
class ProductController extends Controller
{
   ...
   public function file_browser(Request $request){
    ...
    public function reply_comment(Request $request){
        ...
        $comment->comment_name = 'Lọc Nước Núi Thành';
        $comment->save();
    ...
    public function load_comment(Request $request){
        ...
        foreach($comment as $key => $comm){
            ...
            <div class="row style_comment">
                    ...
                    <div class="col-md-2">
                        <img width="50%" src="'.url('/public/frontend/images/user.png').'" class="img img-responsive img-thumbnail">
                    </div>
                    <div class="col-md-10">
                ...
                foreach($comment_rep as $key => $rep_comment)  {
                    ...
                    <div class="col-md-10">
                        <p style="color:blue;">@Lọc nước Núi Thành</p>
    ...
    public function details_product($product_slug , Request $request){
        ...
        $rating = round($rating);
        return view('pages.sanpham.show_details')->with('category',$cate_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('category_post',$category_post)->with('gallery',$gallery)->with('product_cate',$product_cate)->with('cate_slug',$cate_slug)->with('rating',$rating)->with('share_images',$share_images);
    ...
    public function tag(Request $request, $product_tag){
        ...
        $pro_tag = Product::where('product_status',0)->where('product_name','LIKE','%'.$tag.'%')->orWhere('product_slug','LIKE','%'.$tag.'%')->get();
        ...
        return view('pages.sanpham.tag')->with('category_post',$category_post)->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('product_tag',$product_tag)->with('pro_tag',$pro_tag);
