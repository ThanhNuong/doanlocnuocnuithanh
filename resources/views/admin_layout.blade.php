...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Antonio:wght@200&family=Lato:ital,wght@0,300;1,300&family=Nunito+Sans:wght@300&family=Oswald:wght@300&family=Poppins:wght@200&family=Source+Sans+Pro:ital@1&display=swap"
        rel="stylesheet">
...
<body>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="admin" src="{{url('public/frontend/images/admin.jpg')}}">
                            <span class="username">
    ...
    $(document).ready(function() {
        ...
        var chart = new Morris.Line({
            ...
            element: 'chart',
            //option chart
            lineColors: ['#ff9800', '#e91e63', '#00bcd4', 'black', 'red'],
            parseTime: false,
            hideHover: 'auto',
            xkey: 'period',
        ...
        // khi load lại trang thì nó load function và show ra 60ngayf
        ...
        $('#btn-dashboard-filter').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    //sau khi lọc dữ liệu ở filter_by_daate thì trả về biến data ở đầy và sau kết quả
                    chart.setData(data);
                }
            });
