		...
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
				  ...
				  <li class="active" style="color:#000; font-weight:600; font-size: 20px; margin-bottom: -70px;">Thanh toán giỏ hàng</li>
				</ol>
			</div>
							...
							<p>Điền thông tin gửi hàng</p>
								...
								<div class="col-md-6 form-style">
									<form method="POST">
										...
										<input type="button" value="Xác nhận đặt hàng" style="margin-bottom: 15px;" name="send_order" class="btn btn-primary btn-sm send_order">
									</form>
								</div>
								<div class="col-md-6">	
								<form>
