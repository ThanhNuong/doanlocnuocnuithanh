...
class HomeController extends Controller
{
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Chuyên bán máy lọc nước"; 
        $meta_keywords = "máy lọc nước, lọc nước, karofi";
        $meta_title = "Lọc nước Núi Thành | Karofi";
    	...
    	return view('pages.home')->with('category',$cate_product)->with('brand',$brand_product)->with('all_product',$all_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('category_post',$category_post)->with('cate_pro_tabs',$cate_pro_tabs); //1
