                ...
                <div class="position-center">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select name="city" id="city" class="form-control input-sm m-bot15 city choose1">
                        ...
                        <button type="button" name="add_vanchuyen" class="btn btn-info add_vanchuyen">Thêm phí vận
                            chuyển</button>
