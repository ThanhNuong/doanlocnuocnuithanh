...
//function load lại trang cho show 60 ngày
...
public function filter_by_date(Request $request){
    ...
    foreach($get as $key => $val){
        ...
        $chart_data[] = array(
            ...
            'period' => $val->order_date, //1 giai đoạn 
            'order' => $val->total_order, //tổng đơn hàng
            'sales' => $val->sales, //doanh số
            'profit' => $val->profit, //lợi nhuận
            'quantity' => $val->quantity //số lượng bán
        );
    }

    //có dữ liệu rồi trả về json qua biến data
    echo $data = json_encode($chart_data);  
